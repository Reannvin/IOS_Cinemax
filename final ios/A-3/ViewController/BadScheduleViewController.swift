...
class BadScheduleViewController: UIViewController {
...
extension BadScheduleViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "MovieScheduleTimeCell", for: indexPath) as? BadScheduleTimeCell else {
